const TRANSLATIONS = {
  pl: {
    ...
    btn_sync_now: 'Synchronizuj teraz globalne statystyki', sync_never: 'Nigdy',
    ...
    offline_banner: '⚠️ Offline — dane będą zsynchronizowane gdy wróci internet',
    onboarding_title: 'Witaj na Barszcz Festiwal 2026',
  ...
  uk: {
    ...
    btn_sync_now: 'Синхронізувати глобальну статистику', sync_never: 'Ніколи',
    ...
    offline_banner: '⚠️ Офлайн — дані будуть синхронізовані коли з\'явиться інтернет',
    onboarding_title: 'Ласкаво просимо на Barszcz Festiwal 2026',
